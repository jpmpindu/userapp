...
class RestaurantProductSearchScreen extends StatefulWidget {
  ...
  const RestaurantProductSearchScreen({Key key, @required this.storeID})
      : super(key: key);
            ...
            child: SizedBox(
                ...
                child: PaginatedListView(
                  ...
                  onPaginate: (int offset) =>
                      restaurantController.getStoreSearchItemList(
                  ...
                  totalSize:
                      restaurantController.restaurantSearchProductModel != null
                          ...
                          : null,
                  offset: restaurantController.restaurantSearchProductModel !=
                          null
                      ? restaurantController.restaurantSearchProductModel.offset
                      : 1,
                  productView: ProductView(
                    isRestaurant: false,
                    restaurants: null,
                    products:
                        restaurantController.restaurantSearchProductModel !=
                                null
                            ? restaurantController
