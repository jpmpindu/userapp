...
import 'package:ae_user/data/api/api_checker.dart';
import 'package:ae_user/data/model/response/address_model.dart';
import 'package:ae_user/data/model/response/place_details_model.dart';
import 'package:ae_user/data/model/response/prediction_model.dart';
import 'package:ae_user/data/model/response/response_model.dart';
import 'package:ae_user/data/model/response/zone_response_model.dart';
...
import 'package:ae_user/view/base/confirmation_dialog.dart';
import 'package:ae_user/view/base/custom_snackbar.dart';
import 'package:ae_user/view/screens/home/home_screen.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress,
    ...
    _addressModel = AddressModel(
      ...
      zoneData: _responseModel.zoneData,
    );
    _loading = false;
    update();
  ...
  Future<ZoneResponseModel> getZone(String lat, String long, bool markerLoad,
    ...
    if (response.statusCode == 200) {
      ...
      response.body['zone_data']
          .forEach((zoneData) => _zoneData.add(ZoneData.fromJson(zoneData)));
  ...
  Future<ResponseModel> addAddress(AddressModel addressModel, bool fromCheckout,
    ...
    if (response.statusCode == 200) {
      if (fromCheckout &&
          !response.body['zone_ids'].contains(restaurantZoneId)) {
        responseModel = ResponseModel(
