...
import 'package:ae_user/view/base/address_details.dart';
import 'package:ae_user/view/base/custom_divider.dart';
          ...
          : Column(children: [
              ...
              Row(children: [
                ClipOval(
                    child: CustomImage(
                  image:
                      '${_takeAway ? Get.find<SplashController>().configModel.baseUrls.restaurantImageUrl : Get.find<SplashController>().configModel.baseUrls.deliveryManImageUrl}/${_takeAway ? track.restaurant != null ? track.restaurant.logo : '' : track.deliveryMan.image}',
                  height: 35,
                  width: 35,
                  fit: BoxFit.cover,
                )),
                ...
                InkWell(
                  onTap: () async {
                    if (await canLaunchUrlString(
                        'tel:${_takeAway ? track.restaurant != null ? track.restaurant.phone : '' : track.deliveryMan.phone}')) {
                      launchUrlString(
                          'tel:${_takeAway ? track.restaurant != null ? track.restaurant.phone : '' : track.deliveryMan.phone}',
                          mode: LaunchMode.externalApplication);
                    } else {
                      showCustomSnackBar(
                          '${'can_not_launch'.tr} ${_takeAway ? track.restaurant != null ? track.restaurant.phone : '' : track.deliveryMan.phone}');
                    }
                  },
                  child: Container(
